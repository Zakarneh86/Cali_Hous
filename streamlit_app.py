...
with tab2:
    ...
    with col2:
        ...
        st.write('[Syed-Imtiaz Mir](https://www.linkedin.com/in/syed-imtiaz-mir/)', unsafe_allow_html= True)
        st.divider()
        st.subheader('Project mentor:')
        st.markdown('[Shaheer Airaj Ahmed](https://www.linkedin.com/in/shaheerairaj/)', unsafe_allow_html= True)
        st.divider()
