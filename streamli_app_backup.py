...
class WebApp():
    def __init__(self):
        ...
        with self.pageColumns[0]:
             ...
             self.yearBuilt = st.select_slider('Select Year Built', options=range(1850,(datetime.datetime.now().year +1)), key=4)
    ...
    def printPrice(self, price):
        self.predictedPrice.markdown(f'Predicted Price: {price} USD')
